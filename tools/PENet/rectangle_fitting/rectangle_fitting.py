...
class LShapeFitting():
    ...
    def fitting(self, ox, oy):
        ...
        idsets, break_signal = self._adoptive_range_segmentation(ox, oy)
...
class RectangleData():
    ...
    def plot(self):
        ...
        print(self.rect_c_x, self.rect_c_y)
...
def main():
    ...
    while time <= simtime:
        ...
        # print(np.array(ox).shape, np.array(oy).shape)
        # print(ox, oy)
